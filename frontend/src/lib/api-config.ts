...
export const API_URL_STORAGE_KEY = "BOOKTEKA_API_URL";
export const BOOTSTRAP_URL =
  "https://pub-3371f3b8e88841168d038ff444561b3d.r2.dev/config-api.json";
...
// Para probar bootstrap en dev: VITE_FORCE_PRODUCTION=true pnpm tauri dev o pnpm run production:mode
