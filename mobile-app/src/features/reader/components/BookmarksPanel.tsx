...
const styles = StyleSheet.create({
  ...
  countBadge: {
    backgroundColor: THEME.colors.secondaryColor, borderRadius: 5,
    minWidth: 22, height: 22, justifyContent: "center", alignItems: "center",
    paddingHorizontal: 6,
  },
  countBadgeText: { fontSize: 12, fontWeight: "700", color: "#fff" },
  closeButton: { width: 36, height: 36, borderRadius: 5, justifyContent: "center", alignItems: "center" },
  addSection: { paddingHorizontal: 20, paddingVertical: 8 },
  addButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8,
    paddingVertical: 12, borderRadius: 5, backgroundColor: THEME.colors.thirdColor,
  },
  ...
  addInput: {
    ...
    borderRadius: 5, paddingHorizontal: 14, fontSize: 15,
    color: THEME.colors.fontColorTitle, backgroundColor: THEME.colors.fourColor,
  },
  addFormActions: { flexDirection: "row", gap: 10 },
  addFormBtn: { flex: 1, height: 40, borderRadius: 5, justifyContent: "center", alignItems: "center" },
  ...
  bookmarkItem: {
    ...
    paddingVertical: 12, paddingHorizontal: 12, borderRadius: 5,
  ...
  deleteButton: { width: 32, height: 32, borderRadius: 5, justifyContent: "center", alignItems: "center" },
