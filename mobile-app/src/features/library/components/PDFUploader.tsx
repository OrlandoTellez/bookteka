...
const styles = StyleSheet.create({
  ...
  progressFill: {
    height: "100%", backgroundColor: THEME.colors.secondaryColor, borderRadius: 5,
  },
  ...
  retryButton: {
    ...
    borderRadius: 5, backgroundColor: THEME.colors.thirdColor,
  },
  retryButtonText: { fontSize: 14, fontWeight: "600", color: THEME.colors.secondaryColor },
  actions: { flexDirection: "row", gap: 10 },
  cancelButton: {
    flex: 1, paddingVertical: 12, borderRadius: 5,
  ...
  uploadButton: {
    ...
    borderRadius: 5, backgroundColor: THEME.colors.secondaryColor,
  },
