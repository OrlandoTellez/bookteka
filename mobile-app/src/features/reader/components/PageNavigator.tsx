...
const styles = StyleSheet.create({
  ...
  goToCard: {
    ...
    borderRadius: 5, padding: 24, gap: 16,
  },
  ...
  goToInput: {
    ...
    borderRadius: 5, paddingHorizontal: 16, fontSize: 20, fontWeight: "700",
  ...
  goToButton: { flex: 1, height: 44, borderRadius: 5, justifyContent: "center", alignItems: "center" },
