...
const spinnerStyle: CSSProperties = {
  width: 32,
  height: 32,
  border: "3px solid var(--splash-fg, #38332e)",
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "var(--splash-bg, #fcf5ee)",
        color: "var(--splash-fg, #38332e)",
  ...
  return (
    <div
      style={{
        ...
        color: "var(--font-color-title, #e2e8f0)",
        fontSize: "1rem",
        fontFamily: "system-ui, sans-serif",
        zIndex: 9999,
        padding: 24,
    ...
    >
      ...
      >
        ...
        <input
          ...
          placeholder="https://api.tu-bookteka.com/api/v1"
          value={value}
          onChange={(e) => {
          ...
          style={{
            padding: "10px 12px",
            borderRadius: 8,
            border: `1px solid ${showError ? "#ef4444" : "var(--border-color, #334155)"}`,
            background: "var(--four-color, #0f172a)",
            color: "var(--font-color-title, #e2e8f0)",
            fontSize: "0.95rem",
          }}
        />
